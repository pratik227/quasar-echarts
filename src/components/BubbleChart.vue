<template>
    ...
    <q-card-section class="q-pa-none q-pt-md">
      <IEcharts style="height: 250px;" ref="bubbleref" @ready="onReady" :option="bubbleChartOption" :resizable="true"></IEcharts>
    </q-card-section>
  </q-card>
</template>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            SaveImage() {
                const linkSource = this.$refs.bubbleref.getDataURL();
                const downloadLink = document.createElement('a');
                document.body.appendChild(downloadLink);

                downloadLink.href = linkSource;
                downloadLink.target = '_self';
                downloadLink.download = 'BubbleChart.png';
                downloadLink.click();
            }
